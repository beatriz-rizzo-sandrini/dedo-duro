...
export default function Sellout() {
  ...
  const dadosProcessados = useMemo(() => {
    ...
    // 3. Processar itens das planilhas de casa para garantir que apareçam mesmo sem estoque de plataforma e sem vendas
